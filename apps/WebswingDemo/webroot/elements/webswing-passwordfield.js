class WebswingPasswordFieldElement extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <input part="root" type="password" autocorrect="off" autocapitalize="none" autocomplete="off">
        `;
    }
...
customElements.define('webswing-passwordfield', WebswingPasswordFieldElement);