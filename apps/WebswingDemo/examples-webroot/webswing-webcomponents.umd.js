...
`;var M2=Object.defineProperty,p2=Object.getOwnPropertyDescriptor,$1=(e,t,a,i)=>{for(var r=i>1?void 0:i?p2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&M2(t,a,r),r};o.WsToast=class extends I{constructor(){super(),this._toastText=""}render(){return c`
    ...
    `}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-live","polite")}show(e="",t=3e3){return new Promise((a,i)=>{this.className==="show"||(t>=1e3&&(this.style.animation=`fadein 0.5s, fadeout 0.5s ${t-500}ms`),this._toastText=e,this.className="show",setTimeout(()=>{this._toastText="",this.style.animation="",this.className=this.className.replace("show",""),a()},t>=1e3?t:3e3))})}},o.WsToast.styles=[N(b),N(l2)],$1([u()],o.WsToast.prototype,"_toastText",2),o.WsToast=$1([T("ws-toast")],o.WsToast);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*P1(e,t){if(e!==void 0){let a=0;for(const i of e)yield t(i,a++)}}const h2="",c2=()=>{const e=/stage(\w+)/mg,t=window.location.pathname.match(e);return t&&t.length>0?t[0]:""},w=(...e)=>e.filter(Boolean).join(" "),_1=(e,t)=>Math.floor(e+Math.random()*(t-e+1)),g2=e=>new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(e);var u2=Object.defineProperty,m2=Object.getOwnPropertyDescriptor,J=(e,t,a,i)=>{for(var r=i>1?void 0:i?m2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&u2(t,a,r),r};o.WsDetailForm=class extends I{constructor(){super(),this.readonly=!1,this.data={id:_1(300,1e3),name:"",category:"",awardYear:"",prizeAmount:"",status:"",country:"",link:""}}handleInput(e){let{id:t,value:a}=e.target;this.data[t]=a;const i=new CustomEvent("form-changed",{detail:{...this.data},composed:!1,cancelable:!0,bubbles:!1});this.dispatchEvent(i)}getKeyName(e){switch(e){case"id":return"ID";case"name":return"Name";case"category":return"Category";case"awardYear":return"Award year";case"prizeAmount":return"Prize amount";case"status":return"Status";case"country":return"Country";case"link":return"Link"}return""}render(){return this.readonly?c`
...
" id="category" name="category">
                            ${P1(this.categories,e=>c`<option value=${e}>${e}</option>`)}
                        </select></div>
                </div>
                <div class="col-span-12">
...
" id="country" name="country">
                        ${P1(this.countries,e=>c`<option value=${e}>${e}</option>`)}
                        </select></div>
                </div>
            </div>
        </form>
    `}reset(){this.data={id:_1(300,1e3),name:"",category:"",awardYear:"",prizeAmount:"",status:"",country:"",link:""},this.requestUpdate()}},o.WsDetailForm.styles=[N(b),N(h2)],J([u({attribute:!1})],o.WsDetailForm.prototype,"data",2),J([u({attribute:!1})],o.WsDetailForm.prototype,"countries",2),J([u({attribute:!1})],o.WsDetailForm.prototype,"categories",2),J([u({reflect:!1})],o.WsDetailForm.prototype,"readonly",2),o.WsDetailForm=J([T("ws-detail-form")],o.WsDetailForm);const w2=`:host{font-family:Montserrat,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji"}:host(.migration) .dialog-content{background-color:#dff6ff;border:1px solid #00a0db}.overlay{position:fixed;top:0px;right:0px;bottom:0px;left:0px;overflow-y:auto;overflow-x:hidden;background-color:#344a5ecc;z-index:999;outline:none}.dialog{position:fixed;top:0px;right:0px;bottom:0px;left:0px;display:flex;height:100%;width:100%;align-items:center;justify-content:center;z-index:1000;max-height:90%;top:5%}.dialog-content{position:relative;transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));overflow-y:auto;border-radius:.5rem;--tw-bg-opacity: 1;background-color:rgb(255 255 255 / var(--tw-bg-opacity));padding:1.25rem 1rem 1rem;text-align:left;--tw-shadow: 0 20px 25px -5px rgb(0 0 0 / .1), 0 8px 10px -6px rgb(0 0 0 / .1);--tw-shadow-colored: 0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow);transition-property:all;transition-timing-function:cubic-bezier(.4,0,.2,1);transition-duration:.15s}@media (min-width: 640px){.dialog-content{margin-top:2rem;margin-bottom:2rem;width:100%;max-width:32rem;padding:1.5rem}}.dialog-content{max-height:100%}
`;var N2=Object.defineProperty,y2=Object.getOwnPropertyDescriptor,P=(e,t,a,i)=>{for(var r=i>1?void 0:i?y2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&N2(t,a,r),r};o.WsModal=class extends I{constructor(){super(...arguments),this.header="",this.okButtonText="Confirm",this.cancelButtonText="Cancel",this.content="",this.show=!1}_close(e){this.dispatchEvent(new CustomEvent("close",{detail:e}))}open(){this.show=!0}handleClick(){this.show=!1,this._close("ok")}closeModal(e){this.show=!1,this._close(e)}render(){return c`
    ${this.show?c`
        <div class="dialog">
        ...
        `:""}
      `}},o.WsModal.styles=[N(b),N(w2)],P([u()],o.WsModal.prototype,"header",2),P([u()],o.WsModal.prototype,"okButtonText",2),P([u()],o.WsModal.prototype,"cancelButtonText",2),P([u()],o.WsModal.prototype,"content",2),P([u()],o.WsModal.prototype,"show",2),o.WsModal=P([T("ws-modal")],o.WsModal);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},x2=e=>(...t)=>({_$litDirective$:e,values:t});class j2{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,a,i){this._$Ct=t,this._$AM=a,this._$Ci=i}_$AS(t,a){return this.update(t,a)}update(t,a){return this.render(...a)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:I2}=r2,G1=()=>document.createComment(""),F=(e,t,a)=>{var i;const r=e._$AA.parentNode,s=t===void 0?e._$AB:t._$AA;if(a===void 0){const n=r.insertBefore(G1(),s),p=r.insertBefore(G1(),s);a=new I2(n,p,e,e.options)}else{const n=a._$AB.nextSibling,p=a._$AM,l=p!==e;if(l){let d;(i=a._$AQ)===null||i===void 0||i.call(a,e),a._$AM=e,a._$AP!==void 0&&(d=e._$AU)!==p._$AU&&a._$AP(d)}if(n!==s||l){let d=a._$AA;for(;d!==n;){const j=d.nextSibling;r.insertBefore(d,s),d=j}}}return a},E=(e,t,a=e)=>(e._$AI(t,a),e),L2={},T2=(e,t=L2)=>e._$AH=t,A2=e=>e._$AH,h1=e=>{var t;(t=e._$AP)===null||t===void 0||t.call(e,!1,!0);let a=e._$AA;const i=e._$AB.nextSibling;for(;a!==i;){const r=a.nextSibling;a.remove(),a=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B1=(e,t,a)=>{const i=new Map;for(let r=t;r<=a;r++)i.set(e[r],r);return i},b2=x2(class extends j2{constructor(e){if(super(e),e.type!==D2.CHILD)throw Error("repeat() can only be used in text expressions")}ht(e,t,a){let i;a===void 0?a=t:t!==void 0&&(i=t);const r=[],s=[];let n=0;for(const p of e)r[n]=i?i(p,n):n,s[n]=a(p,n),n++;return{values:s,keys:r}}render(e,t,a){return this.ht(e,t,a).values}update(e,[t,a,i]){var r;const s=A2(e),{values:n,keys:p}=this.ht(t,a,i);if(!Array.isArray(s))return this.ut=p,n;const l=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],d=[];let j,h,M=0,g=s.length-1,m=0,D=n.length-1;for(;M<=g&&m<=D;)if(s[M]===null)M++;else if(s[g]===null)g--;else if(l[M]===p[m])d[m]=E(s[M],n[m]),M++,m++;else if(l[g]===p[D])d[D]=E(s[g],n[D]),g--,D--;else if(l[M]===p[D])d[D]=E(s[M],n[D]),F(e,d[D+1],s[M]),M++,D--;else if(l[g]===p[m])d[m]=E(s[g],n[m]),F(e,s[M],s[g]),g--,m++;else if(j===void 0&&(j=B1(p,m,D),h=B1(l,M,g)),j.has(l[M]))if(j.has(l[g])){const z=h.get(p[m]),u1=z!==void 0?s[z]:null;if(u1===null){const X1=F(e,s[M]);E(X1,n[m]),d[m]=X1}else d[m]=E(u1,n[m]),F(e,s[M],u1),s[z]=null;m++}else h1(s[g]),g--;else h1(s[M]),M++;for(;m<=D;){const z=F(e,d[D+1]);E(z,n[m]),d[m++]=z}for(;M<=g;){const z=s[M++];z!==null&&h1(z)}return this.ut=p,T2(e,d),C}}),z2=`:host{min-height:0;display:flex;flex-direction:column}
`;var v2=Object.defineProperty,f2=Object.getOwnPropertyDescriptor,k=(e,t,a,i)=>{for(var r=i>1?void 0:i?f2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&v2(t,a,r),r};o.WsTable=class extends I{constructor(){super(...arguments),this.search="",this.headers=[],this.data=[],this.sortColumn="",this.sortDirection=""}handleSearch(e){this.search=e.target.value}handleSort(e){this.sortDirection||(this.sortDirection="desc"),this.sortDirection=this.sortDirection==="asc"?"desc":"asc",this.sortColumn=e}_view(e){this.dispatchEvent(new CustomEvent("viewRow",{detail:e}))}_edit(e){this.dispatchEvent(new CustomEvent("editRow",{detail:e}))}_delete(e){this.dispatchEvent(new CustomEvent("deleteRow",{detail:e}))}_select(e){this.dispatchEvent(new CustomEvent("selectRow",{detail:e}))}render(){const e=!this.sortColumn||!this.sortDirection?this.data:this.data.sort((i,r)=>{const s=this.sortColumn==="award year"?"awardYear":this.sortColumn;return this.sortDirection==="asc"?i[s]>r[s]?1:-1:i[s]<r[s]?1:-1}),t=this.search?e==null?void 0:e.filter(i=>{var r,s;return((r=i.name)==null?void 0:r.toLowerCase().includes(this.search.toLocaleLowerCase()))||((s=i.country)==null?void 0:s.toLowerCase().includes(this.search.toLocaleLowerCase()))}):e,a=i=>{let r="ml-1 ";const s=i.toLowerCase();return this.sortColumn===s?(r+="bg-gray-200 text-gray-900 group-hover:bg-gray-300 flex-none rounded ",r+=this.sortDirection==="desc"?"rotate-0":"rotate-180"):r+="invisible text-gray-400 group-hover:visible group-focus:visible",r};return c`
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table class="bg-white min-h-[220px] min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200">
                  ${b2(t,i=>i.id,(i,r)=>c`
                    <tr @dblclick=${()=>this._view(i)} @click=${()=>this.handleClick(r,i.country)} class=${w("hover:bg-gray-100",this.selectedRow===r?"bg-gray-200":"")}>
    ...
    `}handleClick(e,t){if(this.selectedRow===e){this.selectedRow=null;return}this.selectedRow=e,this._select(t)}deleteRow(e){this.data.splice(e,1),this.requestUpdate()}updateRow(e,t){for(const a in t)Object.prototype.hasOwnProperty.call(t,a)&&(this.data[e][a]=t[a]);this.requestUpdate()}createRow(e){this.data.push(e),this.requestUpdate()}},o.WsTable.styles=[N(b),N(z2)],k([u({reflect:!0})],o.WsTable.prototype,"search",2),k([u({attribute:!1})],o.WsTable.prototype,"headers",2),k([u({attribute:!1})],o.WsTable.prototype,"data",2),k([H()],o.WsTable.prototype,"selectedRow",2),k([H()],o.WsTable.prototype,"sortColumn",2),k([H()],o.WsTable.prototype,"sortDirection",2),o.WsTable=k([T("ws-table")],o.WsTable);const C2="";var S2=Object.defineProperty,E2=Object.getOwnPropertyDescriptor,t1=(e,t,a,i)=>{for(var r=i>1?void 0:i?E2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&S2(t,a,r),r};o.WsIntro=class extends I{constructor(){super(...arguments),this.introTitle="",this.introDesc="",this.introButton=""}_click(){this.dispatchEvent(new CustomEvent("introClick"))}render(){return c`
      <div class="container mx-auto">
    ...
    `}},o.WsIntro.styles=[N(b),N(C2)],t1([u()],o.WsIntro.prototype,"introTitle",2),t1([u()],o.WsIntro.prototype,"introDesc",2),t1([u()],o.WsIntro.prototype,"introButton",2),o.WsIntro=t1([T("ws-intro")],o.WsIntro);const k2=`:host,slot{display:flex;flex-direction:column;height:100%}:host(.migration){background-color:#dff6ff;border:1px solid #00a0db}
`;var O2=Object.defineProperty,Q2=Object.getOwnPropertyDescriptor,V=(e,t,a,i)=>{for(var r=i>1?void 0:i?Q2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&O2(t,a,r),r};o.WsTabs=class extends I{constructor(){super()}get tabs(){const e=this.shadowRoot.querySelector("slot");return e?e.assignedElements():[]}removeTab(e,t){t.stopPropagation();const a=this.shadowRoot.querySelector("slot");(a?a.assignedElements():[]).forEach(r=>{r.label===e.label&&r.remove()}),this.selectTab(this.tabs[1]),this.requestUpdate()}firstUpdated(){this.tabs.find(e=>e.selected)||this.selectTab(this.tabs[0])}render(){return c`
      <div class="border-b border-gray-200 w-full">
        <nav class="tab-bar flex" aria-label="Tabs">
          ${this.tabs.map(e=>c`
            <span class=${w("inline-flex items-center whitespace-nowrap py-4 px-4 border-b-2 font-medium text-base transition-all",e.selected?"border-primary hover:border-primary hover:text-primary_dark text-primary_dark cursor-default":"border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 cursor-pointer")} @click=${t=>this.selectTab(e)}
                 >
                 <span>${e.label}</span>
                 ${e.closable?c`
    ...
    `}selectTab(e){for(let t of this.tabs)t.selected=t==e;this.requestUpdate()}},o.WsTabs.styles=[N(b),N(k2)],o.WsTabs=V([T("ws-tabs")],o.WsTabs),o.WsTab=class extends I{constructor(){super(...arguments),this.closable=!1}render(){return c`
...
<nav aria-label="Progress" class="px-2 pb-4">
    ...
    <li class="relative pb-4">
        <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=1?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
    ...
    <li class="relative pb-4">
        ...
        <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=2?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${x[0].href} class="group relative flex items-start">
    ...
    <li class="relative pb-4">
    <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=3?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${x[1].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
    ...
    <li class="relative pb-4">
    <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=4?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${x[2].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
        <span class="relative z-10 flex h-5 w-5 items-center justify-center rounded-full bg-primary group-hover:bg-primary_dark">
    ...
    <li class="relative pb-4">
        ...
        <a href=${x[3].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
        <span class="relative z-10 flex h-5 w-5 items-center justify-center rounded-full bg-primary group-hover:bg-primary_dark">
...
<nav aria-label="Progress" class="px-2">
    ...
    <li class="relative pb-4">
        ...
        <div class=${w("ml-2 flex flex-col space-y-2 px-3 py-2",L()==1?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${x[0].stage}</span>
            <!-- <span class="text-sm text-gray-500">${x[0].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    ...
    <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=3?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        ...
        <div class=${w("ml-2 flex flex-col space-y-2 px-3 py-2",L()==2?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${x[1].stage}</span>
            <!-- <span class="text-sm text-gray-500">${x[1].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    ...
    <div class=${w("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",L()>=4?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        ...
        <div class=${w("ml-2 flex flex-col space-y-2 px-3 py-2",L()==3?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${x[2].stage}</span>
            <!-- <span class="text-sm text-gray-500">${x[2].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    <li class="relative pb-4">
        ...
        <div class=${w("ml-2 flex flex-col space-y-2 px-3 py-2",L()==4?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${x[3].stage}</span>
            <!-- <span class="text-sm text-gray-500">${x[3].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
...
<div class="relative grid gap-2 p-2">
    ${c1.nav.map(e=>c`
        <a class=${w(e.current?"bg-gray-700 text-white":"text-gray-300 hover:bg-gray-900 hover:text-white","block rounded-md p-2 transition duration-150 ease-in-out")} href=${e.href}>
        <div class=${"flex items-center"}>
...
`;var J2=Object.defineProperty,F2=Object.getOwnPropertyDescriptor,O=(e,t,a,i)=>{for(var r=i>1?void 0:i?F2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&J2(t,a,r),r};o.WsLayout=class extends I{constructor(){super(...arguments),this.pageTitle="",this.bCenter=!1,this.pageDesc="",this.pageIcon="1",this.toggleSidebar=!1,this.toggleMobileNav=!1,this.getServerUrl=()=>{const e=window.location.href;return e.substring(0,e.indexOf("/migration-examples"))+"/migration-examples"}}toggle(){this.toggleSidebar=!this.toggleSidebar}toggleMobile(){this.toggleMobileNav=!this.toggleMobileNav,this.toggleSidebar&&(this.toggleSidebar=!1)}getImage(e){switch(e){case"1":return $2;case"2":return P2;case"3":return _2;case"4":return G2}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResize.bind(this)),this.onResize()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize.bind(this))}onResize(){window.innerWidth<=767&&!this.toggleMobileNav?this.toggleMobileNav=!0:window.innerWidth>767&&this.toggleMobileNav&&(this.toggleMobileNav=!1),window.innerWidth<=1120&&!this.toggleSidebar?this.toggleSidebar=!0:window.innerWidth>1120&&this.toggleSidebar&&(this.toggleSidebar=!1)}render(){return c`
      <div class="w-full h-full flex flex-col opacity-100 bg-light overflow-hidden">
        <aside class=${w("relative flex md:flex-col md:fixed md:inset-y-0 relative z-50 transition-all",this.toggleSidebar?"md:w-20":"md:w-72",this.toggleMobileNav?"":"h-full")}>
          <div @click=${this.toggle} class=${w("cursor-pointer flex items-center justify-center h-8 absolute w-8 bottom-1/4 z-50 rounded-full bg-primary text-white -right-4 transition hidden md:flex",this.toggleSidebar?"rotate-180":"rotate-0")}>
          ...
          <div class="flex-1 flex flex-col min-h-0 bg-secondary">
            ...
            <div class=${w("flex-1 flex flex-col pb-4 overflow-y-auto w-full",this.toggleMobileNav?"hidden":"flex")}>
              ${this.toggleSidebar?B2:W2}
              ${this.toggleSidebar?R2:H2}
            </div>
            <footer class=${w("flex-shrink-0 bg-secondary p-4 hidden md:flex",this.toggleSidebar?"hidden md:hidden":"flex")}>
        ...
        <main class=${w("flex flex-col relative transition-all h-full overflow-y-auto",this.toggleSidebar?"md:pl-20":"md:pl-72")}>
          ${this.pageTitle&&this.pageDesc?c`
    ...
    `}},o.WsLayout.styles=[N(b),N(U2)],O([u()],o.WsLayout.prototype,"pageTitle",2),O([u()],o.WsLayout.prototype,"bCenter",2),O([u()],o.WsLayout.prototype,"pageDesc",2),O([u()],o.WsLayout.prototype,"pageIcon",2),O([H()],o.WsLayout.prototype,"toggleSidebar",2),O([H()],o.WsLayout.prototype,"toggleMobileNav",2),o.WsLayout=O([T("ws-layout")],o.WsLayout);const V2=`svg path:hover{fill:#78d0f7}:host{min-height:50%}
`;var X2=Object.defineProperty,K2=Object.getOwnPropertyDescriptor,g1=(e,t,a,i)=>{for(var r=i>1?void 0:i?K2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&X2(t,a,r),r};o.WsMap=class extends I{constructor(){super(),this.active="",this.addEventListener("click",e=>{const t=e.composedPath()[0],a=t.getAttribute("data-name");t&&t.localName==="path"&&a&&(this.active=a)})}updated(e){var t;e.has("active")&&(this.paths.forEach(a=>a.classList.remove("fill-primary")),(t=this.shadowRoot.querySelectorAll(`svg path[data-name="${this.active}"]`))==null||t.forEach(a=>a.classList.add("fill-primary")))}render(){return c`
    ...
    `}},o.WsMap.styles=[N(b),N(V2)],g1([u({reflect:!0})],o.WsMap.prototype,"active",2),g1([d2("svg path")],o.WsMap.prototype,"paths",2),o.WsMap=g1([T("ws-map")],o.WsMap);const q2=e2`
...
`,t5=`:host{display:flex;flex-direction:column;height:100%;padding:1rem;box-sizing:border-box;overflow:auto}
`;var a5=Object.defineProperty,e5=Object.getOwnPropertyDescriptor,i5=(e,t,a,i)=>{for(var r=i>1?void 0:i?e5(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&a5(t,a,r),r};o.WsHome=class extends I{constructor(){super(...arguments),this.getServerUrl=()=>{const e=window.location.href;return e.substring(0,e.indexOf("/migration-examples"))+"/migration-examples"}}render(){return c`
      <div class="container mx-auto">
        <div class="bg-white rounded-md shadow-md">
          <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
              ...
              <div class="my-4">
                ...
                <div class="mt-4 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:grid-cols-2">
                  <a href="${this.getServerUrl()}/react/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${R1} alt="React">
                  ...
                  <a href="${this.getServerUrl()}/vue/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${H1} alt="Vue">
                  ...
                  <a href="${this.getServerUrl()}/svelte/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${J1} alt="Svelte">
                  ...
                  <a href="${this.getServerUrl()}/angular/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${F1} alt="Angular">
                  ...
                  <a href="${this.getServerUrl()}/vaadin/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${V1} alt="Vaadin">
    ...
    `}},o.WsHome.styles=[N(b),N(t5)],o.WsHome=i5([T("ws-home")],o.WsHome),Object.defineProperties(o,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
