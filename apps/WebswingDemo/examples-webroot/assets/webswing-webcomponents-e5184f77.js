...
`;var X2=Object.defineProperty,K2=Object.getOwnPropertyDescriptor,N2=(i,t,a,e)=>{for(var r=e>1?void 0:e?K2(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&X2(t,a,r),r};let N1=class extends I{constructor(){super(),this._toastText=""}render(){return g`
    ...
    `}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-live","polite")}show(i="",t=3e3){return new Promise((a,e)=>{this.className==="show"||(t>=1e3&&(this.style.animation=`fadein 0.5s, fadeout 0.5s ${t-500}ms`),this._toastText=i,this.className="show",setTimeout(()=>{this._toastText="",this.style.animation="",this.className=this.className.replace("show",""),a()},t>=1e3?t:3e3))})}};N1.styles=[y(f),y(V2)];N2([m()],N1.prototype,"_toastText",2);N1=N2([L("ws-toast")],N1);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*t2(i,t){if(i!==void 0){let a=0;for(const e of i)yield t(e,a++)}}const q2="",t5=()=>{const i=/stage(\w+)/mg,t=window.location.pathname.match(i);return t&&t.length>0?t[0]:""},N=(...i)=>i.filter(Boolean).join(" "),a2=(i,t)=>Math.floor(i+Math.random()*(t-i+1)),a5=i=>new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(i);var e5=Object.defineProperty,i5=Object.getOwnPropertyDescriptor,l1=(i,t,a,e)=>{for(var r=e>1?void 0:e?i5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&e5(t,a,r),r};let Q=class extends I{constructor(){super(),this.readonly=!1,this.data={id:a2(300,1e3),name:"",category:"",awardYear:"",prizeAmount:"",status:"",country:"",link:""}}handleInput(i){let{id:t,value:a}=i.target;this.data[t]=a;const e=new CustomEvent("form-changed",{detail:{...this.data},composed:!1,cancelable:!0,bubbles:!1});this.dispatchEvent(e)}getKeyName(i){switch(i){case"id":return"ID";case"name":return"Name";case"category":return"Category";case"awardYear":return"Award year";case"prizeAmount":return"Prize amount";case"status":return"Status";case"country":return"Country";case"link":return"Link"}return""}render(){return this.readonly?g`
            <div class="container mx-auto">
                <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                        ...
                        ${Object.entries(this.data).map(([i,t])=>g`
                                    <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                        <dt class="text-sm font-medium text-gray-500">${this.getKeyName(i)}</dt>
                                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                            ${i==="prizeAmount"&&t?a5(t):i==="link"&&t?g`
...
" id="category" name="category">
                            ${t2(this.categories,i=>g`<option value=${i}>${i}</option>`)}
                        </select></div>
                </div>
                <div class="col-span-12">
...
" id="country" name="country">
                        ${t2(this.countries,i=>g`<option value=${i}>${i}</option>`)}
                        </select></div>
                </div>
            </div>
        </form>
    `}reset(){this.data={id:a2(300,1e3),name:"",category:"",awardYear:"",prizeAmount:"",status:"",country:"",link:""},this.requestUpdate()}};Q.styles=[y(f),y(q2)];l1([m({attribute:!1})],Q.prototype,"data",2);l1([m({attribute:!1})],Q.prototype,"countries",2);l1([m({attribute:!1})],Q.prototype,"categories",2);l1([m({reflect:!1})],Q.prototype,"readonly",2);Q=l1([L("ws-detail-form")],Q);const r5=`:host{font-family:Montserrat,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji"}:host(.migration) .dialog-content{background-color:#dff6ff;border:1px solid #00a0db}.overlay{position:fixed;top:0px;right:0px;bottom:0px;left:0px;overflow-y:auto;overflow-x:hidden;background-color:#344a5ecc;z-index:999;outline:none}.dialog{position:fixed;top:0px;right:0px;bottom:0px;left:0px;display:flex;height:100%;width:100%;align-items:center;justify-content:center;z-index:1000;max-height:90%;top:5%}.dialog-content{position:relative;transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));overflow-y:auto;border-radius:.5rem;--tw-bg-opacity: 1;background-color:rgb(255 255 255 / var(--tw-bg-opacity));padding:1.25rem 1rem 1rem;text-align:left;--tw-shadow: 0 20px 25px -5px rgb(0 0 0 / .1), 0 8px 10px -6px rgb(0 0 0 / .1);--tw-shadow-colored: 0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow);transition-property:all;transition-timing-function:cubic-bezier(.4,0,.2,1);transition-duration:.15s}@media (min-width: 640px){.dialog-content{margin-top:2rem;margin-bottom:2rem;width:100%;max-width:32rem;padding:1.5rem}}.dialog-content{max-height:100%}
`;var s5=Object.defineProperty,n5=Object.getOwnPropertyDescriptor,K=(i,t,a,e)=>{for(var r=e>1?void 0:e?n5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&s5(t,a,r),r};let S=class extends I{constructor(){super(...arguments),this.header="",this.okButtonText="Confirm",this.cancelButtonText="Cancel",this.content="",this.show=!1}_close(i){this.dispatchEvent(new CustomEvent("close",{detail:i}))}open(){this.show=!0}handleClick(){this.show=!1,this._close("ok")}closeModal(i){this.show=!1,this._close(i)}render(){return g`
    ${this.show?g`
        <div class="dialog">
        ...
        `:""}
      `}};S.styles=[y(f),y(r5)];K([m()],S.prototype,"header",2);K([m()],S.prototype,"okButtonText",2);K([m()],S.prototype,"cancelButtonText",2);K([m()],S.prototype,"content",2);K([m()],S.prototype,"show",2);S=K([L("ws-modal")],S);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var C1;const y1=window,W=y1.trustedTypes,e2=W?W.createPolicy("lit-html",{createHTML:i=>i}):void 0,v=`lit$${(Math.random()+"").slice(9)}$`,Y1="?"+v,o5=`<${Y1}>`,J=document,x1=(i="")=>J.createComment(i),s1=i=>i===null||typeof i!="object"&&typeof i!="function",y2=Array.isArray,x2=i=>y2(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",t1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,i2=/-->/g,r2=/>/g,k=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),s2=/'/g,n2=/"/g,D2=/^(?:script|style|textarea|title)$/i,F=Symbol.for("lit-noChange"),D=Symbol.for("lit-nothing"),o2=new WeakMap,P=J.createTreeWalker(J,129,null,!1),j2=(i,t)=>{const a=i.length-1,e=[];let r,s=t===2?"<svg>":"",n=t1;for(let o=0;o<a;o++){const d=i[o];let u,M,l=-1,h=0;for(;h<d.length&&(n.lastIndex=h,M=n.exec(d),M!==null);)h=n.lastIndex,n===t1?M[1]==="!--"?n=i2:M[1]!==void 0?n=r2:M[2]!==void 0?(D2.test(M[2])&&(r=RegExp("</"+M[2],"g")),n=k):M[3]!==void 0&&(n=k):n===k?M[0]===">"?(n=r??t1,l=-1):M[1]===void 0?l=-2:(l=n.lastIndex-M[2].length,u=M[1],n=M[3]===void 0?k:M[3]==='"'?n2:s2):n===n2||n===s2?n=k:n===i2||n===r2?n=t1:(n=k,r=void 0);const c=n===k&&i[o+1].startsWith("/>")?" ":"";s+=n===t1?d+o5:l>=0?(e.push(u),d.slice(0,l)+"$lit$"+d.slice(l)+v+c):d+v+(l===-2?(e.push(void 0),o):c)}const p=s+(i[a]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[e2!==void 0?e2.createHTML(p):p,e]};class n1{constructor({strings:t,_$litType$:a},e){let r;this.parts=[];let s=0,n=0;const p=t.length-1,o=this.parts,[d,u]=j2(t,a);if(this.el=n1.createElement(d,e),P.currentNode=this.el.content,a===2){const M=this.el.content,l=M.firstChild;l.remove(),M.append(...l.childNodes)}for(;(r=P.nextNode())!==null&&o.length<p;){if(r.nodeType===1){if(r.hasAttributes()){const M=[];for(const l of r.getAttributeNames())if(l.endsWith("$lit$")||l.startsWith(v)){const h=u[n++];if(M.push(l),h!==void 0){const c=r.getAttribute(h.toLowerCase()+"$lit$").split(v),w=/([.?@])?(.*)/.exec(h);o.push({type:1,index:s,name:w[2],strings:c,ctor:w[1]==="."?A2:w[1]==="?"?L2:w[1]==="@"?T2:p1})}else o.push({type:6,index:s})}for(const l of M)r.removeAttribute(l)}if(D2.test(r.tagName)){const M=r.textContent.split(v),l=M.length-1;if(l>0){r.textContent=W?W.emptyScript:"";for(let h=0;h<l;h++)r.append(M[h],x1()),P.nextNode(),o.push({type:2,index:++s});r.append(M[l],x1())}}}else if(r.nodeType===8)if(r.data===Y1)o.push({type:2,index:s});else{let M=-1;for(;(M=r.data.indexOf(v,M+1))!==-1;)o.push({type:7,index:s}),M+=v.length-1}s++}}static createElement(t,a){const e=J.createElement("template");return e.innerHTML=t,e}}function U(i,t,a=i,e){var r,s,n,p;if(t===F)return t;let o=e!==void 0?(r=a._$Co)===null||r===void 0?void 0:r[e]:a._$Cl;const d=s1(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==d&&((s=o==null?void 0:o._$AO)===null||s===void 0||s.call(o,!1),d===void 0?o=void 0:(o=new d(i),o._$AT(i,a,e)),e!==void 0?((n=(p=a)._$Co)!==null&&n!==void 0?n:p._$Co=[])[e]=o:a._$Cl=o),o!==void 0&&(t=U(i,o._$AS(i,t.values),o,e)),t}class I2{constructor(t,a){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=a}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var a;const{el:{content:e},parts:r}=this._$AD,s=((a=t==null?void 0:t.creationScope)!==null&&a!==void 0?a:J).importNode(e,!0);P.currentNode=s;let n=P.nextNode(),p=0,o=0,d=r[0];for(;d!==void 0;){if(p===d.index){let u;d.type===2?u=new M1(n,n.nextSibling,this,t):d.type===1?u=new d.ctor(n,d.name,d.strings,this,t):d.type===6&&(u=new v2(n,this,t)),this.u.push(u),d=r[++o]}p!==(d==null?void 0:d.index)&&(n=P.nextNode(),p++)}return s}p(t){let a=0;for(const e of this.u)e!==void 0&&(e.strings!==void 0?(e._$AI(t,e,a),a+=e.strings.length-2):e._$AI(t[a])),a++}}class M1{constructor(t,a,e,r){var s;this.type=2,this._$AH=D,this._$AN=void 0,this._$AA=t,this._$AB=a,this._$AM=e,this.options=r,this._$Cm=(s=r==null?void 0:r.isConnected)===null||s===void 0||s}get _$AU(){var t,a;return(a=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&a!==void 0?a:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const a=this._$AM;return a!==void 0&&t.nodeType===11&&(t=a.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,a=this){t=U(this,t,a),s1(t)?t===D||t==null||t===""?(this._$AH!==D&&this._$AR(),this._$AH=D):t!==this._$AH&&t!==F&&this.g(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):x2(t)?this.k(t):this.g(t)}O(t,a=this._$AB){return this._$AA.parentNode.insertBefore(t,a)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==D&&s1(this._$AH)?this._$AA.nextSibling.data=t:this.T(J.createTextNode(t)),this._$AH=t}$(t){var a;const{values:e,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=n1.createElement(r.h,this.options)),r);if(((a=this._$AH)===null||a===void 0?void 0:a._$AD)===s)this._$AH.p(e);else{const n=new I2(s,this),p=n.v(this.options);n.p(e),this.T(p),this._$AH=n}}_$AC(t){let a=o2.get(t.strings);return a===void 0&&o2.set(t.strings,a=new n1(t)),a}k(t){y2(this._$AH)||(this._$AH=[],this._$AR());const a=this._$AH;let e,r=0;for(const s of t)r===a.length?a.push(e=new M1(this.O(x1()),this.O(x1()),this,this.options)):e=a[r],e._$AI(s),r++;r<a.length&&(this._$AR(e&&e._$AB.nextSibling,r),a.length=r)}_$AR(t=this._$AA.nextSibling,a){var e;for((e=this._$AP)===null||e===void 0||e.call(this,!1,!0,a);t&&t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var a;this._$AM===void 0&&(this._$Cm=t,(a=this._$AP)===null||a===void 0||a.call(this,t))}}class p1{constructor(t,a,e,r,s){this.type=1,this._$AH=D,this._$AN=void 0,this.element=t,this.name=a,this._$AM=r,this.options=s,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=D}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,a=this,e,r){const s=this.strings;let n=!1;if(s===void 0)t=U(this,t,a,0),n=!s1(t)||t!==this._$AH&&t!==F,n&&(this._$AH=t);else{const p=t;let o,d;for(t=s[0],o=0;o<s.length-1;o++)d=U(this,p[e+o],a,o),d===F&&(d=this._$AH[o]),n||(n=!s1(d)||d!==this._$AH[o]),d===D?t=D:t!==D&&(t+=(d??"")+s[o+1]),this._$AH[o]=d}n&&!r&&this.j(t)}j(t){t===D?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class A2 extends p1{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===D?void 0:t}}const d5=W?W.emptyScript:"";class L2 extends p1{constructor(){super(...arguments),this.type=4}j(t){t&&t!==D?this.element.setAttribute(this.name,d5):this.element.removeAttribute(this.name)}}class T2 extends p1{constructor(t,a,e,r,s){super(t,a,e,r,s),this.type=5}_$AI(t,a=this){var e;if((t=(e=U(this,t,a,0))!==null&&e!==void 0?e:D)===F)return;const r=this._$AH,s=t===D&&r!==D||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,n=t!==D&&(r===D||s);s&&this.element.removeEventListener(this.name,this,r),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var a,e;typeof this._$AH=="function"?this._$AH.call((e=(a=this.options)===null||a===void 0?void 0:a.host)!==null&&e!==void 0?e:this.element,t):this._$AH.handleEvent(t)}}class v2{constructor(t,a,e){this.element=t,this.type=6,this._$AN=void 0,this._$AM=a,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(t){U(this,t)}}const l5={P:"$lit$",A:v,M:Y1,C:1,L:j2,R:I2,D:x2,V:U,I:M1,H:p1,N:L2,U:T2,B:A2,F:v2},d2=y1.litHtmlPolyfillSupport;d2==null||d2(n1,M1),((C1=y1.litHtmlVersions)!==null&&C1!==void 0?C1:y1.litHtmlVersions=[]).push("2.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M5={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},p5=i=>(...t)=>({_$litDirective$:i,values:t});class h5{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,a,e){this._$Ct=t,this._$AM=a,this._$Ci=e}_$AS(t,a){return this.update(t,a)}update(t,a){return this.render(...a)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:c5}=l5,l2=()=>document.createComment(""),a1=(i,t,a)=>{var e;const r=i._$AA.parentNode,s=t===void 0?i._$AB:t._$AA;if(a===void 0){const n=r.insertBefore(l2(),s),p=r.insertBefore(l2(),s);a=new c5(n,p,i,i.options)}else{const n=a._$AB.nextSibling,p=a._$AM,o=p!==i;if(o){let d;(e=a._$AQ)===null||e===void 0||e.call(a,i),a._$AM=i,a._$AP!==void 0&&(d=i._$AU)!==p._$AU&&a._$AP(d)}if(n!==s||o){let d=a._$AA;for(;d!==n;){const u=d.nextSibling;r.insertBefore(d,s),d=u}}}return a},O=(i,t,a=i)=>(i._$AI(t,a),i),g5={},u5=(i,t=g5)=>i._$AH=t,m5=i=>i._$AH,S1=i=>{var t;(t=i._$AP)===null||t===void 0||t.call(i,!1,!0);let a=i._$AA;const e=i._$AB.nextSibling;for(;a!==e;){const r=a.nextSibling;a.remove(),a=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M2=(i,t,a)=>{const e=new Map;for(let r=t;r<=a;r++)e.set(i[r],r);return e},w5=p5(class extends h5{constructor(i){if(super(i),i.type!==M5.CHILD)throw Error("repeat() can only be used in text expressions")}ht(i,t,a){let e;a===void 0?a=t:t!==void 0&&(e=t);const r=[],s=[];let n=0;for(const p of i)r[n]=e?e(p,n):n,s[n]=a(p,n),n++;return{values:s,keys:r}}render(i,t,a){return this.ht(i,t,a).values}update(i,[t,a,e]){var r;const s=m5(i),{values:n,keys:p}=this.ht(t,a,e);if(!Array.isArray(s))return this.ut=p,n;const o=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],d=[];let u,M,l=0,h=s.length-1,c=0,w=n.length-1;for(;l<=h&&c<=w;)if(s[l]===null)l++;else if(s[h]===null)h--;else if(o[l]===p[c])d[c]=O(s[l],n[c]),l++,c++;else if(o[h]===p[w])d[w]=O(s[h],n[w]),h--,w--;else if(o[l]===p[w])d[w]=O(s[l],n[w]),a1(i,d[w+1],s[l]),l++,w--;else if(o[h]===p[c])d[c]=O(s[h],n[c]),a1(i,s[l],s[h]),h--,c++;else if(u===void 0&&(u=M2(p,c,w),M=M2(o,l,h)),u.has(o[l]))if(u.has(o[h])){const T=M.get(p[c]),A1=T!==void 0?s[T]:null;if(A1===null){const _1=a1(i,s[l]);O(_1,n[c]),d[c]=_1}else d[c]=O(A1,n[c]),a1(i,s[l],A1),s[T]=null;c++}else S1(s[h]),h--;else S1(s[l]),l++;for(;c<=w;){const T=a1(i,d[w+1]);O(T,n[c]),d[c++]=T}for(;l<=h;){const T=s[l++];T!==null&&S1(T)}return this.ut=p,u5(i,d),F}}),N5=`:host{min-height:0;display:flex;flex-direction:column}
`;var y5=Object.defineProperty,x5=Object.getOwnPropertyDescriptor,Z=(i,t,a,e)=>{for(var r=e>1?void 0:e?x5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&y5(t,a,r),r};let z=class extends I{constructor(){super(...arguments),this.search="",this.headers=[],this.data=[],this.sortColumn="",this.sortDirection=""}handleSearch(i){this.search=i.target.value}handleSort(i){this.sortDirection||(this.sortDirection="desc"),this.sortDirection=this.sortDirection==="asc"?"desc":"asc",this.sortColumn=i}_view(i){this.dispatchEvent(new CustomEvent("viewRow",{detail:i}))}_edit(i){this.dispatchEvent(new CustomEvent("editRow",{detail:i}))}_delete(i){this.dispatchEvent(new CustomEvent("deleteRow",{detail:i}))}_select(i){this.dispatchEvent(new CustomEvent("selectRow",{detail:i}))}render(){const i=!this.sortColumn||!this.sortDirection?this.data:this.data.sort((e,r)=>{const s=this.sortColumn==="award year"?"awardYear":this.sortColumn;return this.sortDirection==="asc"?e[s]>r[s]?1:-1:e[s]<r[s]?1:-1}),t=this.search?i==null?void 0:i.filter(e=>{var r,s;return((r=e.name)==null?void 0:r.toLowerCase().includes(this.search.toLocaleLowerCase()))||((s=e.country)==null?void 0:s.toLowerCase().includes(this.search.toLocaleLowerCase()))}):i,a=e=>{let r="ml-1 ";const s=e.toLowerCase();return this.sortColumn===s?(r+="bg-gray-200 text-gray-900 group-hover:bg-gray-300 flex-none rounded ",r+=this.sortDirection==="desc"?"rotate-0":"rotate-180"):r+="invisible text-gray-400 group-hover:visible group-focus:visible",r};return g`
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table class="bg-white min-h-[220px] min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                  <tr>
                    ${this.headers.map((e,r)=>g`
                      <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">
                        <span @click=${()=>r<5?this.handleSort(e.toLowerCase()):null} class="group inline-flex cursor-pointer">
                          ${e}
                          <span class=${a(e)}>
                ...
                <tbody class="divide-y divide-gray-200">
                  ${w5(t,e=>e.id,(e,r)=>g`
                    <tr @dblclick=${()=>this._view(e)} @click=${()=>this.handleClick(r,e.country)} class=${N("hover:bg-gray-100",this.selectedRow===r?"bg-gray-200":"")}>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${e.id}</td>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${e.name}</td>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${e.category}</td>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${e.awardYear}</td>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${e.country}</td>
                      <td class="relative flex space-x-1 justify-center py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
                        <span @click=${()=>this._view(e)} class="text-primary hover:text-primary_dark cursor-pointer">
                        ...
                        <span @click=${()=>this._edit(e)} class="text-primary hover:text-primary_dark cursor-pointer">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                          </svg>
                        </span>
                        <span @click=${()=>this._delete(e)} class="text-primary hover:text-primary_dark cursor-pointer">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
    ...
    `}handleClick(i,t){if(this.selectedRow===i){this.selectedRow=null;return}this.selectedRow=i,this._select(t)}deleteRow(i){this.data.splice(i,1),this.requestUpdate()}updateRow(i,t){for(const a in t)Object.prototype.hasOwnProperty.call(t,a)&&(this.data[i][a]=t[a]);this.requestUpdate()}createRow(i){this.data.push(i),this.requestUpdate()}};z.styles=[y(f),y(N5)];Z([m({reflect:!0})],z.prototype,"search",2);Z([m({attribute:!1})],z.prototype,"headers",2);Z([m({attribute:!1})],z.prototype,"data",2);Z([d1()],z.prototype,"selectedRow",2);Z([d1()],z.prototype,"sortColumn",2);Z([d1()],z.prototype,"sortDirection",2);z=Z([L("ws-table")],z);const D5="";var j5=Object.defineProperty,I5=Object.getOwnPropertyDescriptor,I1=(i,t,a,e)=>{for(var r=e>1?void 0:e?I5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&j5(t,a,r),r};let V=class extends I{constructor(){super(...arguments),this.introTitle="",this.introDesc="",this.introButton=""}_click(){this.dispatchEvent(new CustomEvent("introClick"))}render(){return g`
      <div class="container mx-auto">
    ...
    `}};V.styles=[y(f),y(D5)];I1([m()],V.prototype,"introTitle",2);I1([m()],V.prototype,"introDesc",2);I1([m()],V.prototype,"introButton",2);V=I1([L("ws-intro")],V);const A5=`:host,slot{display:flex;flex-direction:column;height:100%}:host(.migration){background-color:#dff6ff;border:1px solid #00a0db}
`;var L5=Object.defineProperty,T5=Object.getOwnPropertyDescriptor,h1=(i,t,a,e)=>{for(var r=e>1?void 0:e?T5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&L5(t,a,r),r};let k1=class extends I{constructor(){super()}get tabs(){const i=this.shadowRoot.querySelector("slot");return i?i.assignedElements():[]}removeTab(i,t){t.stopPropagation();const a=this.shadowRoot.querySelector("slot");(a?a.assignedElements():[]).forEach(e=>{e.label===i.label&&e.remove()}),this.selectTab(this.tabs[1]),this.requestUpdate()}firstUpdated(){this.tabs.find(i=>i.selected)||this.selectTab(this.tabs[0])}render(){return g`
      <div class="border-b border-gray-200 w-full">
        <nav class="tab-bar flex" aria-label="Tabs">
          ${this.tabs.map(i=>g`
            <span class=${N("inline-flex items-center whitespace-nowrap py-4 px-4 border-b-2 font-medium text-base transition-all",i.selected?"border-primary hover:border-primary hover:text-primary_dark text-primary_dark cursor-default":"border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 cursor-pointer")} @click=${t=>this.selectTab(i)}
                 >
                 <span>${i.label}</span>
                 ${i.closable?g`
      ...
      <div class="p-4 flex flex-col h-full overflow-y-auto">
        <slot part="content" @slotchange=${i=>this.requestUpdate()}></slot>
      </div>
    `}selectTab(i){for(let t of this.tabs)t.selected=t==i;this.requestUpdate()}};k1.styles=[y(f),y(A5)];k1=h1([L("ws-tabs")],k1);let X=class extends I{constructor(){super(...arguments),this.closable=!1}render(){return g`
...
<nav aria-label="Progress" class="px-2 pb-4">
    ...
    <li class="relative pb-4">
        <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=1?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
    ...
    <li class="relative pb-4">
        ...
        <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=2?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${j[0].href} class="group relative flex items-start">
    ...
    <li class="relative pb-4">
    <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=3?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${j[1].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
    ...
    <li class="relative pb-4">
    <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=4?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        <a href=${j[2].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
        <span class="relative z-10 flex h-5 w-5 items-center justify-center rounded-full bg-primary group-hover:bg-primary_dark">
    ...
    <li class="relative pb-4">
        ...
        <a href=${j[3].href} class="group relative flex items-start">
        <span class="flex h-9 items-center">
        <span class="relative z-10 flex h-5 w-5 items-center justify-center rounded-full bg-primary group-hover:bg-primary_dark">
...
<nav aria-label="Progress" class="px-2">
    ...
    <li class="relative pb-4">
        ...
        <div class=${N("ml-2 flex flex-col space-y-2 px-3 py-2",A()==1?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${j[0].stage}</span>
            <!-- <span class="text-sm text-gray-500">${j[0].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    ...
    <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=3?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        ...
        <div class=${N("ml-2 flex flex-col space-y-2 px-3 py-2",A()==2?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${j[1].stage}</span>
            <!-- <span class="text-sm text-gray-500">${j[1].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    ...
    <div class=${N("absolute top-2.5 left-2.5 -ml-px mt-0.5 h-full w-0.5",A()>=4?"bg-primary":"bg-gray-300")} aria-hidden="true"></div>
        ...
        <div class=${N("ml-2 flex flex-col space-y-2 px-3 py-2",A()==3?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${j[2].stage}</span>
            <!-- <span class="text-sm text-gray-500">${j[2].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
    <li class="relative pb-4">
        ...
        <div class=${N("ml-2 flex flex-col space-y-2 px-3 py-2",A()==4?"bg-gray-100 bg-opacity-10 rounded-md":"")}>
            <div class="min-w-0 flex-1 flex flex-col">
            <span class="text-sm font-medium text-gray-200">${j[3].stage}</span>
            <!-- <span class="text-sm text-gray-500">${j[3].desc}</span> -->
            </div>
        </div>
        </a>
    </li>
...
<div class="relative grid gap-2 p-2">
    ${O1.nav.map(i=>g`
        <a class=${N(i.current?"bg-gray-700 text-white":"text-gray-300 hover:bg-gray-900 hover:text-white","block rounded-md p-2 transition duration-150 ease-in-out")} href=${i.href}>
        <div class=${"flex items-center"}>
            <img class="h-6 w-6 mr-2" src=${i.image} />
            ${i.label}
        </div>
        </a>
        `)}
</div>
`;var Z5=Object.defineProperty,Y5=Object.getOwnPropertyDescriptor,Y=(i,t,a,e)=>{for(var r=e>1?void 0:e?Y5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&Z5(t,a,r),r};let b=class extends I{constructor(){super(...arguments),this.pageTitle="",this.bCenter=!1,this.pageDesc="",this.pageIcon="1",this.toggleSidebar=!1,this.toggleMobileNav=!1,this.getServerUrl=()=>{const i=window.location.href;return i.substring(0,i.indexOf("/migration-examples"))+"/migration-examples"}}toggle(){this.toggleSidebar=!this.toggleSidebar}toggleMobile(){this.toggleMobileNav=!this.toggleMobileNav,this.toggleSidebar&&(this.toggleSidebar=!1)}getImage(i){switch(i){case"1":return f5;case"2":return C5;case"3":return S5;case"4":return E5}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResize.bind(this)),this.onResize()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize.bind(this))}onResize(){window.innerWidth<=767&&!this.toggleMobileNav?this.toggleMobileNav=!0:window.innerWidth>767&&this.toggleMobileNav&&(this.toggleMobileNav=!1),window.innerWidth<=1120&&!this.toggleSidebar?this.toggleSidebar=!0:window.innerWidth>1120&&this.toggleSidebar&&(this.toggleSidebar=!1)}render(){return g`
      <div class="w-full h-full flex flex-col opacity-100 bg-light overflow-hidden">
        <aside class=${N("relative flex md:flex-col md:fixed md:inset-y-0 relative z-50 transition-all",this.toggleSidebar?"md:w-20":"md:w-72",this.toggleMobileNav?"":"h-full")}>
          <div @click=${this.toggle} class=${N("cursor-pointer flex items-center justify-center h-8 absolute w-8 bottom-1/4 z-50 rounded-full bg-primary text-white -right-4 transition hidden md:flex",this.toggleSidebar?"rotate-180":"rotate-0")}>
          ...
          <div class="flex-1 flex flex-col min-h-0 bg-secondary">
            ...
            <div class=${N("flex-1 flex flex-col pb-4 overflow-y-auto w-full",this.toggleMobileNav?"hidden":"flex")}>
              ${this.toggleSidebar?k5:O5}
              ${this.toggleSidebar?Q5:U5}
            </div>
            <footer class=${N("flex-shrink-0 bg-secondary p-4 hidden md:flex",this.toggleSidebar?"hidden md:hidden":"flex")}>
        ...
        <main class=${N("flex flex-col relative transition-all h-full overflow-y-auto",this.toggleSidebar?"md:pl-20":"md:pl-72")}>
          ${this.pageTitle&&this.pageDesc?g`
    ...
    `}};b.styles=[y(f),y(v5)];Y([m()],b.prototype,"pageTitle",2);Y([m()],b.prototype,"bCenter",2);Y([m()],b.prototype,"pageDesc",2);Y([m()],b.prototype,"pageIcon",2);Y([d1()],b.prototype,"toggleSidebar",2);Y([d1()],b.prototype,"toggleMobileNav",2);b=Y([L("ws-layout")],b);const $5=`svg path:hover{fill:#78d0f7}:host{min-height:50%}
`;var _5=Object.defineProperty,P5=Object.getOwnPropertyDescriptor,$1=(i,t,a,e)=>{for(var r=e>1?void 0:e?P5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&_5(t,a,r),r};let o1=class extends I{constructor(){super(),this.active="",this.addEventListener("click",i=>{const t=i.composedPath()[0],a=t.getAttribute("data-name");t&&t.localName==="path"&&a&&(this.active=a)})}updated(i){var t;i.has("active")&&(this.paths.forEach(a=>a.classList.remove("fill-primary")),(t=this.shadowRoot.querySelectorAll(`svg path[data-name="${this.active}"]`))==null||t.forEach(a=>a.classList.add("fill-primary")))}render(){return g`
    ...
    `}};o1.styles=[y(f),y($5)];$1([m({reflect:!0})],o1.prototype,"active",2);$1([F2("svg path")],o1.prototype,"paths",2);o1=$1([L("ws-map")],o1);const B5=Z2`
...
`,G5=`:host{display:flex;flex-direction:column;height:100%;padding:1rem;box-sizing:border-box;overflow:auto}
`;var H5=Object.defineProperty,R5=Object.getOwnPropertyDescriptor,W5=(i,t,a,e)=>{for(var r=e>1?void 0:e?R5(t,a):t,s=i.length-1,n;s>=0;s--)(n=i[s])&&(r=(e?n(t,a,r):n(r))||r);return e&&r&&H5(t,a,r),r};let Q1=class extends I{constructor(){super(...arguments),this.getServerUrl=()=>{const i=window.location.href;return i.substring(0,i.indexOf("/migration-examples"))+"/migration-examples"}}render(){return g`
      <div class="container mx-auto">
        <div class="bg-white rounded-md shadow-md">
          <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
              ...
              <div class="my-4">
                ...
                <div class="mt-4 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:grid-cols-2">
                  <a href="${this.getServerUrl()}/react/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${z2} alt="React">
                  ...
                  <a href="${this.getServerUrl()}/vue/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${b2} alt="Vue">
                  ...
                  <a href="${this.getServerUrl()}/svelte/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${f2} alt="Svelte">
                  ...
                  <a href="${this.getServerUrl()}/angular/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${C2} alt="Angular">
                  ...
                  <a href="${this.getServerUrl()}/vaadin/" class="col-span-1 flex justify-center items-center bg-gray-50 py-8 px-8">
                    <img class="max-h-12" src=${S2} alt="Vaadin">
    ...
    `}};Q1.styles=[y(f),y(G5)];Q1=W5([L("ws-home")],Q1);
//# sourceMappingURL=webswing-webcomponents-e5184f77.js.map
